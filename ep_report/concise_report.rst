...
.. csv-table:: Baseline
   ...
   "**Progr RV pace**", "VA conduction ${get('Prog V Pace_VA conduction')}, VAERP ${get('Prog V Pace_VAERP')}ms, Atrial activation ${get('Prog V Pace_Atrial Activation')}, VERP ${get('Prog V Pace_VERP')}ms"
    ...
    "**Prog A pace**", "AH jump ${get('Prog A Pace_AH jump')} ms, ${noblanks('SPERP ',get('Prog A Pace_SPERP'), ' ms,')} ${noblanks('FPERP ',get('Prog A Pace_FPERP'), ' ms,')} ${noblanks('APERP ', get('Prog A Pace_APERP'), ' ms,')} ${noblanks('AVERP ', get('Prog A Pace_AVERP'), ' ms,')} AERP ${get('Prog A Pace_AERP')} ms"
